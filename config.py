...
COSTOM_TEXT_START = getenv("COSTOM_TEXT_START", """Saya Adalah Bot Canggih Yang Dibuat Untuk Memutar Musik Di Obrolan Suara Grup Telegram

Tekan » /help « Untuk Melihat Daftar Perintah Saya!"""
